...
class lab_comunicaciones(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "lab_comunicaciones")
...
def main(top_block_cls=lab_comunicaciones, options=None):
